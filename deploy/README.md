...
Бот — это программа, которая должна где-то работать. Пока она не запущена, @SpeakOutEducation_bot молчит. Ниже три способа, от самого быстрого к самому правильному.
